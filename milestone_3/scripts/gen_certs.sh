# I borrowed this script for generating certificates from the following repository.
# https://github.com/gbahamondezc/node-grpc-ssl/blob/master/scripts/gen_certs.sh
